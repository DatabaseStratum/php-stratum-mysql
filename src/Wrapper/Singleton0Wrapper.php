...
class Singleton0Wrapper extends Wrapper
{
  ...
  protected function writeResultHandler(): void
  {
    ...
    {
      $this->codeStore->append('return !empty($this->executeSingleton0(\'call '.$this->routine['routine_name'].'('.$routineArgs.')\'));');
    }
    else
    {
      $this->codeStore->append('return $this->executeSingleton0(\'call '.$this->routine['routine_name'].'('.$routineArgs.')\');');
    }
  }
